...
public class UserDataRepository implements IRepository, IUserRepository {
    ...
    public Observable<List<User>> getList() {
        ...
        final IBidDataStore userDataStore = this.userDataStoreFactory.createCloudDataStore();
    ...
    public Observable<User> getItem(int userId) {
        final IBidDataStore userDataStore = this.userDataStoreFactory.create(userId);
